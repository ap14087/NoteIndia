package com.amanpandey.noteindia.auth;
...
import com.amanpandey.noteindia.MainActivity;
import com.amanpandey.noteindia.R;
...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Login to NoteIndia");
        ...
        loginNow.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
        ...
        createAcc.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
